 ...
 * @subpackage Skins
 */
class SkinBedrock extends SkinTemplate {
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'bedrock';
		$this->stylename = 'bedrock';
		$this->template  = 'BedrockTemplate';
	}
}
	
class BedrockTemplate extends QuickTemplate {
	/**
	 * Template filter callback for Bedrock skin.
