 ...
 * @subpackage Skins
 */
class SkinPOPLmark extends SkinTemplate {
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'poplmark';
		$this->stylename = 'poplmark';
		$this->template  = 'POPLmarkTemplate';
	}
}
	
class POPLmarkTemplate extends QuickTemplate {
	/**
	 * Template filter callback for POPLmark skin.
  ...
  <body <?php if($this->data['body_ondblclick']) { ?>ondblclick="<?php $this->text('body_ondblclick') ?>"<?php } ?>
	...
	<div class="portlet" id="p-personal">
	  ...
	  <div class="portlet" id="p-logo"> 
          <div style="width: 128px; height:93px; background: #f5f5e7;  margin-left:auto; 
margin-right:auto; margin-top: 0em;" > 
	  <a  href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>"
	    title="<?php $this->msg('mainpage') ?>"><img src="<?php $this->text('logopath') ?>" border="0" /></a>
          </div> 
	</div>
